...
SH_price_impact_cost_results1 <- parLapply(cl, compute_date[1:100], function(calculate_date){
...
SH_price_impact_cost_results1 <- bind_rows(SH_price_impact_cost_results1)
...
#####----Ending----#####
save.image("./01-D-Price-Impact-Cost.RData")
